import { buttonTheme } from '../helperFiles/generalStyling';
...
function EditItem( itemData ) {
    ...
    useEffect(() => {
        if (1) {
            setItemText(itemData.itemData.itemName);
            setCurrentlySelected(itemData.itemData.itemStatus);
            setLocationText(itemData.itemData.itemLocation);
            if (itemData.itemData.itemStatus === "LOAN") {
                setLoanedText(itemData.itemData.itemLoanedTo);
            }
            setTagsSelected(itemData.itemData.tags);
            setItemID(itemData.itemData._id);
        ...
        locationText.trim().length !== 0) {
            ...
            if (hiddenBool === false && loanedText.trim().length !== 0) {
                axios({
                    method: "post",
                    withCredentials: true,
                    url: process.env.REACT_APP_DATABASE_URL + "/itemRegister/delete_item/" + itemID,
                }).then((res) => console.log(res));
            ...
            /*axios({
                ...
                withCredentials: true,
                url: process.env.REACT_APP_DATABASE_URL + "/image/upload_image",
            }).then((res) => console.log(res));*/
    ...
    console.log("Test:nameValue", currentlySelected);
